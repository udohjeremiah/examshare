    ...
    <div className="flex flex-col items-center gap-6 px-4 py-14 md:px-10">
      ...
      <div className="max-w-prose space-y-6">
        ...
        <p>
          ...
          <strong>&apos;You&apos;</strong>), and ExamShare, concerning your
        ...
        <p>
          The &quot;Last Updated&quot; title above (at the beginning of this
          document, after &quot;Terms and Conditions&quot;), indicating the date
          of this document, will reflect changes in the legal terms.
        </p>
        <p>
        ...
        <ul className="list-disc space-y-6 pl-10">
          ...
          <li>
            ...
            this Agreement) refers to ExamShare, 25 Chichester Road, Sapele,
            Delta State, Nigeria.
          </li>
          <li>
          ...
          <li>
            ...
            &quot;Terms&quot;) mean those Terms and Conditions that form the
        ...
        <p>
          ...
          distribution to or use by an person or entity in any jurisdiction or
        ...
        <p>
          ...
          in our Services, including all source code, databses, functionality,
        ...
        <ul className="list-disc space-y-6 pl-10">
          <li>access ther Services; and</li>
          <li>
        ...
        <p>
          Except as set our in this section or elsewhere in our Legal Terms, no
          part of the Services and no Content or Marks may be copied,
          reproduced, aggregated, republished, uploaded, posted, publicly
          displayed, encoded, translated, transmitted, distributed, solid,
        ...
        <p>
          Please review this section and the &apos;PROHIBITED ACTIVTIES&apos;
        ...
        <p>
          ...
          shall own this Submission and be entitle to its unrestricted use and
        ...
        <p>
          ...
          continue to, or participate in blogs, message boards, online forums,
          ...
          text, writings, video, audio, photographs, musics, graphics, comments,
        ...
        <ul className="list-disc space-y-6 pl-10">
          ...
          <li>
            ...
            such Submissions and/or Contributions and that you have fully
        ...
        <p>
          You are solely responsible for your Submisions and/or Contributions
        ...
        <p>
          ...
          breacnh of these Legal Terms. If we remove or edit any such
        ...
        <p>
          We respect the intellectual property right of others. If you believe
        ...
        <p>
          You may not access or use the Services for any purpose other than for
        ...
        <ul className="list-disc space-y-6 pl-10">
          ...
          <li>
            ...
            interferes with any party&apos; uninterrupted use and enjoyment of
          ...
          <li>
            Harass, annoy, intimidate, or threaten any our our employees or
          ...
          <li>
            ...
            utility, scrapper, or offline reader that accesses the Services, or
          ...
          <li>
            Use of the Services as part of any effort to compete with us or
          ...
          <li>Sell or othewise transfer your profile.</li>
        </ul>
        <h3 className="mb-2 text-2xl font-medium text-slate-900 dark:text-white">
        ...
        <p>
          ...
          materials to use or on the Services, including but not limited to
        ...
        <ul className="list-disc space-y-6 pl-10">
          ...
          <li>
            You are the creator and owner of or have the necesary licences,
          ...
          <li>
            You have the wrtitten consent, release, and/or permission of each
          ...
          <li>
            ...
            violent, harrasing, libellous, slanderous, or otherwise
          ...
          <li>
            Your Contributions are not used to harrass or threaten (in the legal
        ...
        <p>
          The licence will apply to any form, media, or technology now known or
          hereafter developed, and includes our use of your name, company name,
          and franchise name, as applicable, and any of the trademakrs, service
          marks, trade names, logos and personal and commercial images you
        ...
        <p>
          ...
          rights or other property rights associated with your Contributions. We
          are not liable for any statements or representations in your
          Contributions provided by you in any area of the Services. You are
        ...
        <p>
          ...
          disablity; (4) your reviews should not contain references to illegal
          ...
          legality or conduct; (7) you may not post any false or misleading
        ...
        <p>
          ...
          resulting for any review. By posting a review, you hereby grant to us
        ...
        <p>
          ...
          other websites (&apos;Third-Psrty Websites&apos;) as well as articles,
          ...
          Third-Party Websites or the Third-PartyWebsites or any Thirrd-Party
          ...
          gathering practices, of any websites to which you navigate from the
          Services or relating to any application you use or install from the
          ...
          responsibility whatsoever in relation to such purchaases which are
        ...
        <p>
          ...
          the jurisdiction of the Nigeria courts. ExamShare shall also maintain
          ...
          are entered into in the course of your trade or profession, the state
        ...
        <p>
          There may be information on the Servicees that contains typographical
          errros, inaccuracies, or omissions, including descriptions, pricing,
        ...
        <p>
          ...
          the Services. You agree that we shall have no liabilty to you for any
          loss or corrupting of any such data, and you hereby waive any right of
          actio against us arising from any such loss or corruption of such
          data.
        </p>
        <h3 className="mb-2 text-2xl font-medium text-slate-900 dark:text-white">
