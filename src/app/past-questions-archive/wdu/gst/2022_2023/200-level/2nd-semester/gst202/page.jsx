  ...
  return (
    ...
    >
      ...
      <li>
        ...
        <strong>FEWER</strong> stands for _______
      ...
      <li>
        ...
        <strong>PACRP</strong> stands for _______
      ...
      <li>
        ...
        <sup>st</sup> generation right (b) 2<sup>nd</sup> generation right (c) 3
        <sup>rd</sup> generation right (d) 4<sup>th</sup> generation right
      ...
      <li>
        ...
        <strong>ECOWAS</strong> was established in the year _______
        <Answers questionNumber="28" />
      </li>
      <li>
        <h4 className="mb-2 font-bold">Question 29</h4>
        <strong>CEDAW</strong> stands for _______
      ...
      <li>
        ...
        <strong>UNAMSIL</strong> stands for _______
