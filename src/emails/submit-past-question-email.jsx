...
export default function SubmitPastQuestionEmail({ fullName }) {
  const previewText =
  ...
  return (
    <Html>
      <Head>
        <title>Past Question Submitted Successfully | ExamShare</title>
      </Head>
        ...
        <Body className="m-auto bg-white font-inter text-slate-600">
          <Container className="mx-auto my-10 w-1/2 rounded border border-solid border-slate-200">
            ...
            <Section className="px-10">
              <Heading as="h2">PAST QUESTION SUBMITTED SUCCESSFULLY</Heading>
              <Text>Hello {fullName},</Text>
              <Text>
                Thank you for reaching out to us. Your past question has been
                received successfully. Our team is currently reviewing the
                details you provided, and we will get back to you as soon as
                possible.
              </Text>
              <Text>
